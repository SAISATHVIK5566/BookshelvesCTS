...
public class ExcelWrite {
	...
	public static String exFilePath2 = "./excel/LivingSubmenu.xlsx";
	...
	public static void byAtHomeLiving(String[] bookShelves, int x) {
		
		workbook = new XSSFWorkbook();
		sheet = workbook.createSheet("Livingitems");

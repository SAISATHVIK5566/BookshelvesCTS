...
public class HomePageGiftCards {
	...
	public static WebElement enterCustomerAddress(WebDriver driver) {
	...
	public static WebElement enterCustomerPin(WebDriver driver) {
	...
	public static WebElement txtConfirmDetailsHeading(WebDriver driver) {
		
		element = driver.findElement(By.xpath("//h2[contains(text(),'Confirm the details')]"));
		return element;
